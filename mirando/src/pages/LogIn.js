            ...
            <div className='max-w-[450px] h-[600px] mx-auto bg-black text-white'>
              <div className='max-w-[320px] mx-auto py-16 '>
                ...
                <form className='w-full flex flex-col py-4'>
                  <input className='py-3 my-2 bg-gray-800 rounded' type="email" placeholder="  Email" autoComplete='email'/>
                  <input className='py-3 my-2 bg-gray-800 rounded' type="password" placeholder="  Password" autoComplete="current-password" />
                  ...
                  <p className='py-8'>
                    <span className='text-gray-600'> New to Mirando ?</span>{'     '}
